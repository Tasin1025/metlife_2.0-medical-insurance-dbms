...
<head>
    ...
    <title>Orders</title>
    <link rel="stylesheet" href="./showorderstyle.css">
...
<nav>
            <div
                ...
                <div class="hidden md:flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 ">
                    <a class="btn btn-ghost text-lg text-white font-medium">Recent Orders</a>
                    <a class="btn btn-ghost text-lg text-white font-medium">Add Product</a>
                    <a class="btn btn-ghost text-lg text-white font-medium">Manage Stuffs</a>
